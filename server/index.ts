...
const app=await createApp({dataDir,serveDir:process.argv.includes('--production')?path.join(root,'dist'):undefined,dailyChallengeSecret:process.env.DAILY_CHALLENGE_SECRET});
